...
class BertModel(object):
  ...
  def __init__(self,
               ...
               input_rows,
               input_cols,
               token_col_table=None,
               token_row_table=None,
               input_mask=None,
               input_mask_3d=None,
               token_type_ids=None,
    ...
    with tf.variable_scope(scope, reuse=reuse):
      with tf.variable_scope("embeddings"):
        ...
        self.embedding_output = embedding_postprocessor(
            ...
            use_token_type=True,
            token_col_ids=input_cols,
            token_row_ids=input_rows,
            token_row_table=token_row_table,
            token_col_table=token_col_table,
