...
from tag_op.tagop.modeling_adapter import TableSpecificBERTTAdapter
...
# parser.add_argument("--data_dir", type=str, default="tag_op/cache/")
...
def main():
    ...
    #     print('check')
    #     input()
    #     bert_model = RobertaModel.from_pretrained('FacebookAI/roberta-large')
    # elif args.encoder == 'finbert':
    #     bert_model = BertModel.from_pretrained(args.finbert_model)
    bert_model = TapasModel.from_pretrained('google/tapas-large')
